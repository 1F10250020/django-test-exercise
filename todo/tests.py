...
class TodoViewTestCase(TestCase):
    ...
    def test_index_get_search(self):
        task1 = Task(title='Apple task', due_at=timezone.make_aware(datetime(2026, 7, 1)))
        task1.save()
        task2 = Task(title='Banana task', due_at=timezone.make_aware(datetime(2026, 8, 1)))
        task2.save()
        client = Client()
    ...
    def test_update_post_success(self):
        ...
        task.save()
        client = Client()
        data = {'title': 'updated task', 'due_at': '2026-06-24 23:59:59'}
        ...
        self.assertEqual(updated_task.due_at, timezone.make_aware(datetime(2026, 6, 24, 23, 59, 59)))
